    ...
    with st.container():
        ...
        right_col.markdown(
            f"""
                ...
                <h6 style='text-align: justify; color: black; font-style: italic;'>
                If you find value using this webserver, please cite our paper: <br>
                Adhish, M., Manjubala, I. <i>PPGBioPred: a webserver for predicting the bioactivity of 
                compounds against PPARγ involved in the negative regulation of the Wnt/β-catenin signaling pathway.</i> 
                <i>Mol Divers (2025).</i> https://doi.org/10.1007/s11030-025-11297-1.
                </h6>    
